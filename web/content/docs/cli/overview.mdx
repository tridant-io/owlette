...
keywords: ["command line", "terminal", "npx", "shell"]
---
...
| [`machine live-view`](/docs/cli/reference/machine) | stub | — | streaming desktop feed; remote desktop ships as swoop, so the stub points at `owlette swoop` |
| [`swoop`](/docs/cli/reference/swoop) | ready | — | open the remote-desktop viewer for a machine in your browser |
...
**stub (exit 3 only)**
```json
{ "ok": false, "stub": true, "noun": "machine", "reason": "remote desktop is shipping as swoop; this verb lands with it", "dashboard_url": "https://owlette.app/dashboard", "future_plan": "public-api deferred: swoop" }
```
