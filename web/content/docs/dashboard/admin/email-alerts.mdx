...
Each user's [**account settings -> alerts**](/docs/dashboard/account-settings#alerts) section controls:
...
**Admin Panel -> email** (`/admin/email`) configures the platform's mail sender, so it is operated by owlette and is not part of the site-scoped admin panel. If alert email is not arriving for your site, work through [troubleshooting](#troubleshooting) below and contact [support@tridant.io](mailto:support@tridant.io).
