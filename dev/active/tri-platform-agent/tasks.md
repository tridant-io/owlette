...
**Progress (2026-09-25, after the overnight run)**: Wave 0 — 0.2 (a)/(b) measured on the MBA, 0.4 Linux half met on the kiosk VM (reboot), macOS half short of a reboot; Wave 4 — 4.1/4.2/4.6/4.7 posix arms merged (#211/#212), 4.3 job runner and the macOS half of 4.4 merged (#231), macOS title bar / menubar / Dock behaviour (#228/#229), login-item deferral (#233); Wave 5 — 5.1 unsigned `.pkg` built and inspected (#232), 5.2 `.deb`s built, installed and verified on the kiosk VM (#235); Wave 6 — the machines API carries `osFamily`/`arch`/`osVersion` (#237). Owed to the owner: Apple team id (signing, notarization, 0.6), a Mac reboot, a dashboard session to pair the MBA, the Screen Recording grant for `owlette.app`.
